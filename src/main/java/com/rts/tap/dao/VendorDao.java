...
//	public List<Candidate> getAllCandidatesByVendorId(Long vendorId);
	...
	List<MRFVendor> findAllMRFvendorDetailsByRmId(Long rmId);
...
//	public List<Candidate> getAllCandidatesAssignedByVendorAndMrfJdId(Long vendorId, Long mrfJdId);
	...
	List<MRFVendor> getAllAssignedVendors();
	...
	Candidate getCandidateByVendorAndMrfId(Long vendorId, Long mrfId);

	List<Candidate> getHiredAndJoinedCandidatesAssignedByVendorId(Long vendorId);

	List<Candidate> getAllCandidatesByVendorId(Long vendorId);

	List<Candidate> getAllCandidatesAssignedByVendorAndMrfJdId(Long vendorId, Long mrfJdId);
}
