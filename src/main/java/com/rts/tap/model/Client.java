...
public class Client {
	...
	public Client(Long clientId, String clientName, String clientPosition, String clientMobile, String clientEmail,
			String password, String clientStatus, ClientActivationStatus activationStatus, Date createdAt, String otp,
			LocalDateTime expirationTime, Employee clientPartner, ClientOrganization clientOrganization,
